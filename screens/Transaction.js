...
Alert.alert("This studentId doesn't exist in the database")
...
isStudentEligible = true;
  ...
  isStudentEligible = false
  Alert.alert("This student has more than 2 books issued")
}
  })
}
...
if(transactionRef.docs.length === 0){
  ...
  isStudentEligible = false;
  Alert.alert("Student is not eligible to return book")
}
var lastVisibleTransaction = doc.data();
if(lastVisibleTransaction.student_id === student_id){
  isStudentEligible = true
